...
export default function QtyButton({ name, variants, stock, selectedVariant }) {
    ...
    const handleCart = () => {
        setSuccess(true)
        dispatchCart(addToCart(variants[selectedVariant], qty, name, stock[selectedVariant].qty))
    }
